...
_G.packer_plugins = {
  ...
  ["csv.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/csv.vim",
  ...
  ["jellybeans.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/jellybeans.vim",
    url = "https://github.com/nanotech/jellybeans.vim"
  },
  ["julia-vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/julia-vim",
  ...
  ["neovim-ayu"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/neovim-ayu",
  ...
  ["vim-github-dark"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-github-dark",
    url = "https://github.com/wojciechkepka/vim-github-dark"
  },
  ["vim-slime"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-slime",
    url = "https://github.com/jpalardy/vim-slime"
  },
  ["vim-slime-cells"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-slime-cells",
